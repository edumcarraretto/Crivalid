...
const sectionStars = [
  ...
  { left: '4%', top: '20%', size: 2, delay: 1.7, duration: 4.8 },
  { left: '8%', top: '79%', size: 2, delay: 0.4, duration: 5.3 },
  { left: '12%', top: '68%', size: 3, delay: 2.2, duration: 4.5 },
  { left: '18%', top: '32%', size: 2, delay: 0.9, duration: 5.6 },
  { left: '20%', top: '92%', size: 2, delay: 2.8, duration: 4.7 },
  { left: '28%', top: '53%', size: 2, delay: 1.3, duration: 5.1 },
  { left: '33%', top: '3%', size: 3, delay: 0.2, duration: 4.9 },
  { left: '35%', top: '61%', size: 2, delay: 2.4, duration: 5.4 },
  { left: '40%', top: '88%', size: 2, delay: 1.1, duration: 4.6 },
  { left: '46%', top: '47%', size: 3, delay: 2.7, duration: 5.2 },
  { left: '50%', top: '15%', size: 2, delay: 0.6, duration: 4.8 },
  { left: '53%', top: '96%', size: 2, delay: 1.9, duration: 5.5 },
  { left: '60%', top: '22%', size: 3, delay: 0.3, duration: 4.7 },
  { left: '61%', top: '69%', size: 2, delay: 2.5, duration: 5.3 },
  { left: '66%', top: '46%', size: 2, delay: 1.4, duration: 4.9 },
  { left: '70%', top: '84%', size: 3, delay: 0.7, duration: 5.6 },
  { left: '76%', top: '7%', size: 2, delay: 2.1, duration: 4.5 },
  { left: '79%', top: '55%', size: 2, delay: 1, duration: 5.2 },
  { left: '85%', top: '39%', size: 3, delay: 2.6, duration: 4.8 },
  { left: '88%', top: '94%', size: 2, delay: 0.5, duration: 5.4 },
  { left: '93%', top: '18%', size: 2, delay: 1.8, duration: 4.6 },
  { left: '95%', top: '75%', size: 3, delay: 0.8, duration: 5.1 },
] as const
