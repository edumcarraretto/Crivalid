...
export function IdeaMockup() {
  ...
  return (
    <div className="w-full max-w-md mx-auto rounded-xl border border-neutral-200 bg-white shadow-[0_32px_64px_-12px_rgba(124,58,237,0.15)] overflow-hidden flex flex-col">
